...
function CellDirective($parse:IParseService) {
    return {
        restrict: 'E',
        replace: true,
        transclude: true,
        require: '^mdtRow',
        link: function($scope:IScope, element:any, attr:any, mdtRowCtrl:any, transclude:any) {
...
angular
    .module('mdDataTable')
    .directive('mdtCell', CellDirective);